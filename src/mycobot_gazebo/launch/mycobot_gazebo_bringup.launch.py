# Description: Launch a robotic arm in Gazebo import os
...
def generate_launch_description():
  ...
  default_robot_name = 'mycobot'
  gazebo_launch_file_path = 'launch'
  gazebo_models_path = 'models'
  ros_gz_bridge_config_file_path = 'config/ros_gz_bridge.yaml'
  rviz_config_file_path = 'rviz/mycobot_description.rviz'
  urdf_file_path = 'urdf/mycobot_gazebo.urdf.xacro' 
  ...
  default_rviz_config_path = os.path.join(pkg_share_bringup, rviz_config_file_path)  

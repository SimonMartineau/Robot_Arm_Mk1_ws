...
def generate_launch_description():
    ...
    bringup_package = 'mycobot_bringup'
    urdf_filename = 'mycobot_280_urdf.xacro'
    rviz_config_filename = 'mycobot_description.rviz'
 
    # Set paths to important files
    pkg_share_description = FindPackageShare(urdf_package)
    pkg_share_bringup = FindPackageShare(bringup_package)
    default_urdf_model_path = PathJoinSubstitution([pkg_share_description, 'urdf', urdf_filename])
    default_rviz_config_path = PathJoinSubstitution([pkg_share_bringup, 'rviz', rviz_config_filename])
